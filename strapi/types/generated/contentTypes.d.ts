...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer with user and plan relation';
  ...
  attributes: {
    billing_period: Schema.Attribute.Enumeration<['monthly', 'yearly']> &
      Schema.Attribute.DefaultTo<'monthly'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credits_available: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    current_subscription_id: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    mollie_customer_id: Schema.Attribute.String;
    ...
    subscription_status: Schema.Attribute.Enumeration<
      ['active', 'inactive', 'cancelled', 'trial']
    > &
...
export interface ApiEmailTemplateEmailTemplate
  ...
  info: {
    description: 'Templates for HTML emails';
...
export interface ApiVacatureVacature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    application_email: Schema.Attribute.Email & Schema.Attribute.Required;
    application_url: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.DefaultTo<'Mid Level'>;
    expires_at: Schema.Attribute.Date;
    is_active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vacature.vacature'
    > &
      Schema.Attribute.Private;
    ...
    salary_max: Schema.Attribute.Integer;
    salary_min: Schema.Attribute.Integer;
    salary_period: Schema.Attribute.Enumeration<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    company_name: Schema.Attribute.String & Schema.Attribute.Configurable;
    confirmationToken: Schema.Attribute.String & Schema.Attribute.Private;
    confirmed: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    country: Schema.Attribute.String &
      Schema.Attribute.Configurable &
      Schema.Attribute.DefaultTo<'Netherlands'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credits_available: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    is_trial_active: Schema.Attribute.Boolean &
    ...
    plan: Schema.Attribute.Relation<'manyToOne', 'api::plan.plan'>;
    plan_id: Schema.Attribute.Relation<'manyToOne', 'api::plan.plan'>;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.Configurable;
    street_address: Schema.Attribute.String & Schema.Attribute.Configurable;
    sub_sector: Schema.Attribute.Enumeration<
      [
        'Aannemer',
        'APK Keuringsstation',
        'Airco installateur',
    ...
    subscription_start_date: Schema.Attribute.Date;
    subscription_status: Schema.Attribute.Enumeration<
      ['active', 'inactive', 'cancelled', 'trial', 'expired']
    > &
      Schema.Attribute.DefaultTo<'inactive'>;
    total_paid: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    trial_end_date: Schema.Attribute.DateTime;
    trial_start_date: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::vacature.vacature': ApiVacatureVacature;
