      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-600 mb-6">
            Welkom bij Pito App. Deze algemene voorwaarden regelen uw gebruik van onze website en diensten. Door onze diensten te gebruiken, gaat u akkoord met deze voorwaarden.
          </p>
          ...
          <p className="text-gray-600 mb-4">
            Pito App is niet aansprakelijk voor indirecte schade of verlies voortvloeiend uit het gebruik van onze diensten.
          </p>
