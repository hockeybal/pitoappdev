...
export const Footer = async ({
  ...
  return (
    <div className="relative">
      <div className="border-t border-neutral-200 px-8 pt-20 pb-32 relative bg-primary">
...
const LinkSection = ({
  ...
  <div className="flex justify-center space-y-4 flex-col mt-4">
    {links.map((link) => (
      <Link
        key={link.text}
        className="transition-colors hover:text-brand-blue text-muted text-xs sm:text-sm"
